...
describe('parseFrameSpec', () => {
  it('parses a valid spec with jpg/png/webp entries', () => {
    const spec = parseFrameSpec({
      screenshots: [
        { id: 'ep01-f01', source: 'media/input/1999/videos/ep01.mp4', at: '00:01:20', format: 'jpg' },
        { id: 'ep01-f02', source: 'media/input/1999/videos/ep01.mp4', at: 95, format: 'png' },
        { id: 'ep01-f03', source: 'media/input/1999/videos/ep01.mp4', at: '00:01:40.5', format: 'webp' },
      ],
    })
...
describe('resolveFrameEntry', () => {
  it('defaults the output dir to the provided default (work→output mirror)', () => {
    const entry = parseFrameSpec({
      screenshots: [{ id: 'ep01-f01', source: 'a.mp4', at: '00:01:20', format: 'jpg' }],
    }).screenshots[0]!
    expect(resolveFrameEntry(entry, 'media/output/1999/screenshots/ep1')).toEqual({
      at: 80,
      output: 'media/output/1999/screenshots/ep1/ep01-f01.jpg',
    })
  })

  it('an explicit dir wins over the provided default', () => {
    const entry = parseFrameSpec({
      screenshots: [{ id: 'ep01-f01', source: 'a.mp4', at: 95, format: 'webp', dir: 'media/output/1999/screenshots/ep2' }],
    }).screenshots[0]!
    expect(resolveFrameEntry(entry, 'media/output/1999/screenshots/ep1')).toEqual({
      at: 95,
      output: 'media/output/1999/screenshots/ep2/ep01-f01.webp',
    })
  })
})